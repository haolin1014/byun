	...
	<div>
		<div class="layout">
		     <Menu mode="horizontal" theme="dark" active-name="0">
		         <div class="layout-logo"><span class="logo">焙云后台</span></div>
		         <div class="layout-nav">
		             ...
		             <MenuItem name="4">
		             	 <router-link tag="div" to="/order"><Icon type="ios-list"></Icon> 订单</router-link>
		             </MenuItem>
		             <MenuItem name="5">
		             	 <router-link tag="div" to="/finance"><Icon type="social-yen"></Icon> 财务</router-link>
		             </MenuItem>
<!-- 		             <MenuItem name="6">
		             	 <router-link tag="div" to="/setting"><Icon type="android-settings"></Icon> 设置</router-link>
		             </MenuItem> -->
		         </div>
